...
public class userModel {
    ...
    public userModel() throws ParseException {
        ...
        account.setTotalLimit(60000);
        account.setMonthLimit(5000);
        ...
        transactions.add( new Transaction(sdf.parse("17-01-2020"), 3125,
        ...
        transactions.add( new Transaction(sdf.parse("11-02-2020"), 150,
                "Microsoft office subscription", Transaction.Type.REGULARPAYMENT,
